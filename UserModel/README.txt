UserModel es una herramienta que ayuda a estimar el consumo de recursos dentro de una empresa que tenga sus sistemas virtualizados, basándose en la predicción del número de usuarios que se van a conectar en un servidor en una determinada fecha y hora.
